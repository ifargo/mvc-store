...
require_once (ROOT.'/views/layouts/header.php');?>
    ...
    <div class="home">
        ...
        <div class="home_content d-flex flex-column align-items-center justify-content-center">
            <h2 class="home_title">Каталог товаров</h2>
        </div>
    </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="shop_content">
                        <div class="shop_bar clearfix">
                            <div class="shop_product_count"><span><?php echo count($product); ?></span> products found</div>
                        ...
                        <div class="product_grid">
                            ...
                            <div class="product_item is_new">
                                ...
                                <div class="product_content">
                                    ...
                                    <div class="product_name"><div><a href="/product/<?php echo $productItem['id'] ?>" tabindex="0"><?php echo $productItem['name'] ?></a></div></div>
                                </div>
