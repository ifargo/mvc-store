        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li data-image="images/single_4.jpg"><img src="<?php echo \testShop\models\Product::getImage($product['id']);?>" alt=""></li>
                        <li data-image="images/single_2.jpg"><img src="<?php echo \testShop\models\Product::getImage($product['id']);?>" alt=""></li>
                        <li data-image="images/single_3.jpg"><img src="<?php echo \testShop\models\Product::getImage($product['id']);?>" alt=""></li>
                    </ul>
                </div>

                <!-- Selected Image -->
                <div class="col-lg-5 order-lg-2 order-1">
                    <div class="image_selected"><img src="<?php echo \testShop\models\Product::getImage($product['id']);?>" alt=""></div>
                </div>

                <!-- Description -->
                <div class="col-lg-5 order-3">
                    <div class="product_description">
                        <div class="product_category"><?php foreach ($categories as $categoryItem){if ($product['id'] == $categoryItem['id']){echo $categoryItem['name'];}}?></div>
                            ...
                            <form action="#">
                                ...
                                <div class="button_container">
                                    <a href="/cart/add/<?php echo $product['id'] ?>">
                                        <button type="button" class="button cart_button" data-id="<?php echo $product['id'] ?>">Add to Cart</button>
                                    </a>
